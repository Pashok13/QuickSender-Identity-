	...
	public class UserService : IUserService
	{
		...
		public async Task<OperationDetails> Create(UserDTO userDto)
		{
			...
			if (user == null)
			{
				...
				if (user == null)
				{
					user = new ApplicationUser { Email = userDto.Email, UserName = userDto.Name, PhoneNumber = userDto.Phone };
					...
					ClientProfile clientProfile = new ClientProfile { Id = user.Id, Name = userDto.Name, Phone = userDto.Phone, Email = userDto.Email };
